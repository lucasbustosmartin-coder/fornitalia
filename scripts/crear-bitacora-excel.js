...
const funcionalidades = [
  ...
  ['Moneda', 'Selector ARS / USD. Maestro caja→moneda (medio de pago) alineado a scripts/lib/fornitalia-moneda-por-medio.js en import normalizado y en esTransaccionUSD. En ARS: prioridad monto_cambio, tipo_cambio por fila y tabla tipo_de_cambio (MEP/CCL/Oficial); con MEP y datos cargados coincide con el informe PDF.'],
  ...
  ['Análisis financiero extracto (PDF)', 'npm run analisis-financiero-pdf: métricas desde Fornitalia_Movimientos.xlsx (fallback Extracto legado); ARS vía MontoCambio/Monto en $, TC por fila o MEP; exclusiones y USD sin conversión. Ver docs/ANALISIS_FINANCIERO_EXTRACTO_README.md.'],
];
