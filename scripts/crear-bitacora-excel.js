...
const funcionalidades = [
  ...
  ['Por categoría (matriz)', 'Solapa del modal: detalle agrupado por nueva_categoria con fallback a extracto/validación (categoriaDistribucionFlujo); bloques Ingresos / Costo directo / indirecto / Otros costos; Ver para listado de transacciones.'],
  ...
  ['Exclusiones (flujo operativo)', 'No se incluyen en G/P operativo, Evolución ni Caución: anulados; apertura/cierre (categoría o heurística en fila); Transferencia ni Deposito/Depósito; meses desmarcados en Configuración → Inclusión por mes (meses_excluidos en Supabase/localStorage). Traspasos en solapa dedicada. Base histórica y Todas las transacciones siguen completas.'],
  ['Traspasos internos (solapa)', 'Listado de movimientos con categoría extracto Transferencia o Deposito/Depósito (no anulados), con monto de registro y equivalente en moneda de vista; columnas extracto y categoría/cuenta de matriz (nueva en BD o fallback).'],
  ...
  ['Exportar a Excel', 'Botón en la barra de la tabla (solo icono). Exporta la tabla de transacciones tal como está en Supabase: una hoja "Transacciones" con columnas fecha, mes, anio, tipo_movimiento, monto (valor numérico para fórmulas), status, medio_pago, moneda, descripcion, cliente, categoria, cat_desc, origen_archivo, cuenta_contable, editado, editado_detalle. Export Errores: incluye categoria_matriz y cuenta_matriz (misma lógica que el dashboard); monto como número.'],
  ...
  ['Edición desde modal Errores', 'En el detalle de errores, icono de edición por registro. Abre modal para corregir: Categoría y Cuenta contable solo desde valores existentes en BD; Descripción libre. UPDATE en transacciones solo si hubo cambios respecto a la fila; si no, aviso (antes el modal cerraba sin guardar). Tras UPDATE se verifica que haya filas actualizadas; nota contextual para inconsistencia categoría/cuenta/descripción. editado y editado_detalle al guardar con cambios.'],
  ...
  ['Tipo de error en Errores', 'Tabla de errores muestra columna Tipo de error: Inconsistencia entre Categoria, Cuenta Contable y Descripcion; o Potencial registro duplicado. Excepciones explícitas cat/cuenta (Impuestos/IIBB, Logistica/Fletes, Alquileres varias cuentas, Activos/Hornos, Mantenimiento/Ferreteria, Sueldos/Comisiones Ventas y variantes, Marketing/Creación contenido, Honorarios/Honorarios Contables) no marcan inconsistencia. Export a Excel incluye tipo_error.'],
  ...
  ['Evolución (tabla dinámica)', 'Solapa Evolución: Agrupar por = Nueva categoría (matriz) o Nueva cuenta contable (matriz) —prioriza nueva_categoria / nueva_cuenta_contable en BD y si faltan usa extracto con validación—; Período = Diario o Mensual (MM-YYYY). Columnas = períodos, celdas = neto en moneda seleccionada, columna Total.'],
  ...
  ['Config por usuario en Supabase', 'Tabla config_dashboard (user_id, proyección, caución, alertas y meses_excluidos JSON). Con Auth anónimo se sincroniza al cargar y al guardar; la config persiste por usuario en la base. Migración: supabase_config_dashboard.sql; meses excluidos: supabase_config_dashboard_meses_excluidos.sql.'],
  ...
  ['Upload de extracto normalizado', 'Botón en la app para reemplazar transacciones desde la hoja Normalizado (generada con npm run normalizar-extracto desde Fornitalia_Movimientos), con validación previa, IDs y cat_desc persistidos cuando existen, confirmación de seguridad, id_origen técnico y carga en lotes.'],
